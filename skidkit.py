...
def other():
        ...
        try:
            ...
            if menu1 == "7":
                xd = input("IP/Site to traceroute: ")
                try:
                    os.system("traceroute " + xd)
                except:
                    lel = ("You dont have traceroute installed. Would you like to have it installed? \033[0;33m(\033[0;33mY\033[92;40m/\033[0;33mN)\33[37: ")
                    if lel == "y":
                        os.system("sudo apt install traceroute")
                    if lel == "Y":
                        os.system("sudo apt install traceroute")
                    else:
                        print("ok lol")
